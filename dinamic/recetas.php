<?php 
	...
	if ($key_current == "5ebbc694efef1dd8c7e0c1a7" ) {		  //Pan Marraqueta
?>		
<header>
	...
	<?php
	if ($key_current == "5ebbcb62bfddf54ed8a8d95e" ) {		  //Pan integral
	?>		
		<header>
		<title>Recetas: <?php echo "$name_receta" ?> </title>
		</head>
	...
	?>	
	<?php
	if ($key_current == "5ebbce54d9b5ad448fdac8ab" ) {		  //Pan molde
	?>		
		<header>
			<title>Recetas: <?php echo "$name_receta" ?> </title>
		</header>
	...
	?>		
	<?php
	if ($key_current == "5ebbce84d9b5ad448fdac8ac" ) {		  //Pan cebolla
	?>		
		<header>
			<title>Recetas: <?php echo "$name_receta" ?> </title>
		</header>
